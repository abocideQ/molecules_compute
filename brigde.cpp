...
void Brigde::set_q_info(char *_pUrl_q, string g, long double h, long double c, long double KTex, long double KTvib, long double KTrot, int gne, int gno, long double gbase)
{
   m_q_pUrl = _pUrl_q;
   m_q_g = g;
   m_q_h = h;
...
{
     m_pComputeQ->init(m_pParseX->ParseStr2VJ(m_q_g, m_q_t, m_q_pUrl), m_q_h, m_q_c, m_q_KTex, m_q_KTvib, m_q_KTrot, m_q_gne, m_q_gno, m_q_gbase);
