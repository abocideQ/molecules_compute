...
public:
    ...
    void set_q_info(char *_pUrl_q, string g, long double h, long double c, long double k, long double Tex, long double Tvib, long double Trot, int gne, int gno, long double gbase);
    //compute x & a
